...
class Block(nn.Module):
    ...
    def forward(self, x, att_bias):
        x = x + self.drop_path1(self.ls1(self.attn(self.norm1(x),att_bias)))
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.att_bias = nn.Parameter(torch.zeros(1, depth, num_heads, num_patches + self.num_tokens + num_reg, num_patches + self.num_tokens + num_reg))
